                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
                        ...
                        <div style={{ display: 'flex', gap: 6 }}>
                          ...
                          {hasInterview && <span style={{ background: hasScore ? 'rgba(16,185,129,0.15)' : 'rgba(245,158,11,0.15)', color: hasScore ? '#34d399' : '#fbbf24', fontSize: 10, fontWeight: 700, padding: '2px 8px', borderRadius: 20 }}>{hasScore ? 'Evaluated ✓' : 'Interview ✓'}</span>}
                        </div>
                      </div>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: '24px 28px' }}>
                      ...
                      {!vs && (
                        <div style={{ textAlign: 'center', padding: '20px', background: 'rgba(245,158,11,0.08)', borderRadius: 12, border: '1px solid rgba(245,158,11,0.2)' }}>
                          <p style={{ color: '#fbbf24', fontSize: 13, fontWeight: 600, margin: '0 0 14px' }}>⏳ Interview submitted — AI evaluation pending</p>
                          <button
